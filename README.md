...
<div align="center"><img src="https://user-images.githubusercontent.com/71310074/195986286-96a6f8a0-899d-4c47-aad2-1fee9aa2e7c5.png" width="500"></div>
...
# 사용 기술
- server, framework : `nodejs`, `nestjs`, `typescript`
- RDBMS : `mysql`
- ORM : `typeorm`
- API testing : `postman`
- auth strategy : `passport`, `passport-jwt`
...
- 전체적으로 DB 모델링에 대한 고민이 많았으며 개선점이 많다고 생각합니다. [데이터베이스 모델링 개선 방안](https://github.com/YebinLeee/wanted-pre-onboarding-backend/blob/main/modified.md)
